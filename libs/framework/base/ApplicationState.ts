...
export class ApplicationState {
  ...
  public static readonly push = (applicationModule: IApplicationModule) => {
  ...
  public static readonly getBreadcrumb = (url: string) => {
    ...
    return breadcrumb.map((o): IApplicationBreadcrumbItem => ({ path: o.value as string, title: o.title }));
  }
}